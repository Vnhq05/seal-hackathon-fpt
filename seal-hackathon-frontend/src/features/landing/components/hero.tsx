      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-20 sm:px-6 md:py-28 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-32">
        ...
        <div className="max-w-xl">
          ...
          <div className="mt-10 flex gap-8">
            <div>
              <p className="font-heading text-2xl font-bold text-seal-text">24+</p>
              <p className="font-mono text-[10px] uppercase tracking-wider text-seal-text-secondary">
                Open competitions
              </p>
            </div>
            <div>
              <p className="font-heading text-2xl font-bold text-seal-text">1,200+</p>
              <p className="font-mono text-[10px] uppercase tracking-wider text-seal-text-secondary">
                Global participants
              </p>
            </div>
            <div>
              <p className="font-heading text-2xl font-bold text-seal-text">300+</p>
              <p className="font-mono text-[10px] uppercase tracking-wider text-seal-text-secondary">
                Ideas shipped
              </p>
            </div>
