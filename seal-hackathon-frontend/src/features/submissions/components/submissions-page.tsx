...
import type { Submission, SubmissionStatus } from "@/features/submissions/types/submission.types";
    ...
    >
      ...
      >
        <span className="flex items-center gap-1">
          ...
          <span style={metaStyle}>{formatDate(submission.submittedAt)}</span>
        </span>
        {submission.score !== null && (
          <span className="flex items-center gap-1">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
              <path d="M6 1l1.5 3 3.3.5-2.4 2.3.6 3.2L6 8.5 3 10l.6-3.2L1.2 4.5l3.3-.5L6 1z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
            </svg>
            <span style={metaStyle}>Score: {submission.score}</span>
          </span>
        )}
      </div>
    </div>
