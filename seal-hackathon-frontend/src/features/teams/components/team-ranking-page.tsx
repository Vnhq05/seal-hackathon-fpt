...
import type { RankedTeam } from "@/features/teams/types/team-ranking.types";
...
function MemberAvatarStack({ members }: { members: RankedTeam["members"] }) {
      ...
      {displayed.map((member, i) => (
        ...
        >
          {member.avatarUrl ? (
            ...
            <span
              style={{ fontSize: 10, fontWeight: 600, color: "#8891a5" }}
            >
...
export function TeamRankingPage() {
  const { data, isLoading, isError } = useTeamRankings();
    ...
    <div className="flex min-h-full flex-col">
      ...
      >
        <div style={{ maxWidth: 1280 }}>
          ...
          >
            Team Rankings &mdash; {data.hackathonName}
          </h1>
          <p
            style={{
              fontSize: 14,
          ...
          >
            Live leaderboard based on judging scores. Last updated{" "}
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr>
                    ...
                    <th style={headerCellStyle}>Track</th>
                    <th style={{ ...headerCellStyle, width: 100 }}>Score</th>
                    <th style={{ ...headerCellStyle, width: 140 }}>Members</th>
                  </tr>
                </thead>
                <tbody>
                  {data.rankings.map((team, idx) => {
                    const rowStyle: React.CSSProperties = {
                      ...(team.isCurrentUserTeam ? highlightRowStyle : {}),
                      borderBottom:
                        idx < data.rankings.length - 1
                    ...
                    return (
                      <tr key={team.id} style={rowStyle}>
                        <td style={bodyCellStyle}>
                          <MedalBadge rank={team.rank} />
                        </td>
                        <td style={bodyCellStyle}>
                          <span
                            style={{
                              fontWeight: team.isCurrentUserTeam ? 600 : 400,
                              color: "#0e1528",
                            }}
                          >
                            {team.name}
                        ...
                        <td style={bodyCellStyle}>
                          <span
                            style={{
                              ...
                              fontWeight: 500,
                              color: "#8891a5",
                              backgroundColor: "rgba(198,198,205,0.15)",
                              padding: "4px 8px",
                              borderRadius: 4,
                            }}
                          >
