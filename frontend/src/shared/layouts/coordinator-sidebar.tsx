...
const NAV_ITEMS = [
  ...
  { href: "/coordinator/submissions", label: "Submissions", icon: <svg width="18" height="18" viewBox="0 0 18 18" {...svgProps}><path d="M4 2h10a1 1 0 011 1v12a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1z" {...s15} /><path d="M6 6h6M6 9h6M6 12h4" {...s15} {...cap} /></svg> },
