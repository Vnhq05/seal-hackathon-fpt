...
const NAV_ITEMS = [
  ...
  { href: "/admin/hackathons", label: "Event Management", icon: <svg width="18" height="18" viewBox="0 0 18 18" {...svgProps}><path d="M9 1l2.47 5.01L17 6.81l-4 3.9.94 5.49L9 13.61l-4.94 2.59L5 10.71l-4-3.9 5.53-.8L9 1z" {...s15} /></svg> },
  ...
  { href: "/admin/feedback", label: "Feedback", icon: <svg width="18" height="18" viewBox="0 0 18 18" {...svgProps}><path d="M3 3h12v9H8l-4 3v-3H3V3z" {...s15} strokeLinejoin="round" /><path d="M6 6h6M6 9h4" {...s12} {...cap} /></svg> },
  { href: "/admin/audit-logs", label: "Audit Logs", icon: <svg width="18" height="18" viewBox="0 0 18 18" {...svgProps}><rect x="3" y="2" width="12" height="14" rx="2" {...s15} /><path d="M6 6h6M6 9h6M6 12h4" {...s12} {...cap} /></svg> },
