...
export default function LecturerSupportRoute() {
  return (
    <div className="mx-auto max-w-2xl py-8">
      <h1 className="font-mono text-2xl font-bold text-seal-text">Support</h1>
      <p className="mt-2 text-sm text-seal-text-secondary">
        Need help? Reach out through the channels below.
      </p>

      <div className="mt-8 grid gap-4">
        <div className="flex items-start gap-4 border-2 border-navy bg-white shadow-[4px_4px_0_0_#0c1228] p-5">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-violet-50 text-violet-500">
            <MailIcon />
          </div>
          <div>
            <h3 className="font-mono text-sm font-semibold text-seal-text">Email Support</h3>
