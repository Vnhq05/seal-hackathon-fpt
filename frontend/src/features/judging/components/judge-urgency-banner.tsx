...
function AlertIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <circle cx="10" cy="10" r="8.5" stroke="#92400e" strokeWidth="1.3" />
      <path d="M10 6v5M10 13.5h.01" stroke="#92400e" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <AlertIcon />
        <span style={{ fontSize: 14, fontWeight: 700, color: "#92400e", lineHeight: "21px" }}>
          {urgency.message}
        </span>
      </div>
      <Link
