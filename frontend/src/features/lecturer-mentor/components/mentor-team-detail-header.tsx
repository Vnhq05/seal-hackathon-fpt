...
import type { MentorTeamDetail } from "@/features/lecturer-mentor/types/mentor.types";
...
export function MentorTeamDetailHeader({ team }: Props) {
  ...
  return (
    <div
      className="flex items-start justify-between overflow-hidden border-2 border-navy bg-white shadow-[4px_4px_0_0_#0c1228]"
