...
import { useMentorTeamDetail } from "@/features/lecturer-mentor/hooks/use-mentor-team-detail";
import { usePortalBase } from "@/shared/hooks/use-portal-base";
import { MentorTeamDetailHeader } from "@/features/lecturer-mentor/components/mentor-team-detail-header";
import { MentorTeamMembers } from "@/features/lecturer-mentor/components/mentor-team-members";
import { MentorRoundCard } from "@/features/lecturer-mentor/components/mentor-round-card";
...
export function MentorTeamDetailPage({ teamId }: Props) {
  ...
  const { data, isLoading, isError } = useMentorTeamDetail(teamId, eventId);
