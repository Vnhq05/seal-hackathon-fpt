const PLATFORM_FEATURES = [
  { title: "Discover Competitions", description: "Browse and filter active hackathons by category, format, and deadline." },
  { title: "Team Management", description: "Create teams, invite members, and coordinate work in one place." },
  { title: "Round-Based Submissions", description: "Submit projects by round with versioning and deadline tracking." },
  { title: "Mentor Support", description: "Connect with experienced mentors for guidance and feedback." },
  { title: "Transparent Judging", description: "Structured scoring criteria with clear rubrics and judge assignments." },
  { title: "Live Rankings", description: "Real-time leaderboards and results across all competition rounds." },
];
