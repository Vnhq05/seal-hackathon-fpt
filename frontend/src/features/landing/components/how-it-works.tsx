const HOW_IT_WORKS_STEPS = [
  { num: "01", title: "Discover", description: "Browse active hackathons across categories — AI, web, mobile, sustainability and more." },
  { num: "02", title: "Form Your Crew", description: "Build a team with complementary skills or join an existing crew looking for talent." },
  { num: "03", title: "Build & Submit", description: "Develop your solution, iterate with mentor feedback, and submit before the deadline." },
  { num: "04", title: "Compete & Launch", description: "Present to judges, earn recognition, and turn your prototype into something real." },
];
