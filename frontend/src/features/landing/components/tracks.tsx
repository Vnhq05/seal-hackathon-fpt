type Track = { name: string; description: string; accent: string; span?: string };

const TRACKS: Track[] = [
  { name: "Artificial Intelligence", description: "Build intelligent systems that learn, adapt and solve complex problems.", accent: "cyan", span: "col-span-2" },
  { name: "Web & Cloud", description: "Craft scalable web apps and cloud-native solutions.", accent: "blue" },
  { name: "Mobile Experience", description: "Design mobile-first experiences that people love to use.", accent: "pink" },
  { name: "Sustainability", description: "Create tech that drives environmental and social impact.", accent: "mint" },
  { name: "Cybersecurity", description: "Defend systems, detect threats, and secure the digital frontier.", accent: "purple", span: "col-span-2" },
  { name: "Open Innovation", description: "No limits — build whatever pushes the boundary.", accent: "yellow" },
];
