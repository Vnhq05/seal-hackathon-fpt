...
import { useStaffParticipants, useDeactivateParticipant } from "@/features/staff/hooks/use-staff-participants";
import type { Participant, ParticipantStatus } from "@/features/staff/types/staff.types";
...
function ParticipantRow({ p, onDeactivate }: { p: Participant; onDeactivate: (id: string) => void }) {
  return (
...
export function ParticipantManagementPage() {
  ...
  const { mutate: deactivate } = useDeactivateParticipant();
          ...
          <table className="w-full" style={{ borderCollapse: "collapse" }}>
            ...
            <tbody>
              {isLoading
                ...
                : participants.map((p) => <ParticipantRow key={p.id} p={p} onDeactivate={(id) => deactivate(id)} />)
              }
            </tbody>
          </table>
        </div>
