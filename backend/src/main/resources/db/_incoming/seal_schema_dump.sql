/* SEAL schema dump (schema-only) — generated from live catalog */
...
CREATE TABLE [dbo].[flyway_schema_history] (
    ...
    [installed_on] datetime NOT NULL CONSTRAINT [DF__flyway_sc__insta__71F1E3A2] DEFAULT (getdate()),
...
CREATE TABLE [dbo].[users] (
  ...
  , CONSTRAINT [CK__users__status__797309D9] CHECK ([status]='LOCKED' OR [status]='REJECTED' OR [status]='ACTIVE' OR [status]='PENDING')
